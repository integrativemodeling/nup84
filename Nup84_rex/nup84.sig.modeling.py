...
execfile("nup84.sig.topology.py")
...
xl3 = IMP.pmi.restraints.crosslinking.SigmoidalCrossLinkMS(simo,
...
xl4 = IMP.pmi.restraints.crosslinking.SigmoidalCrossLinkMS(simo,
