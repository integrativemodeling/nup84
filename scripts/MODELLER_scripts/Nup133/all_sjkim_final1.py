...
aln = alignment(env)
aln.append(file='all_align_begin1.ali')
aln.write(file='all_align_final1.ali', alignment_format='PIR')
aln.write(file='all_align_final1.pap', alignment_format='PAP')
aln.id_table(matrix_file='all_align_final1.mat')
aln.check()
...
#       Use a harmonic potential and X-Y distance group.
        ...
        rsr.add(forms.upper_bound(group=physical.xy_distance,
                               feature=features.distance(at['CA:60'],
                                                         at['CA:4']),
                               mean=17.0, stdev=5.0))
                                       
        rsr.add(forms.upper_bound(group=physical.xy_distance,
                               feature=features.distance(at['CA:136'],
                                                         at['CA:184']),
                               mean=17.0, stdev=5.0))

        rsr.add(forms.upper_bound(group=physical.xy_distance,
                               feature=features.distance(at['CA:113'],
                                                         at['CA:136']),
                               mean=17.0, stdev=5.0))

        rsr.add(forms.upper_bound(group=physical.xy_distance,
                               feature=features.distance(at['CA:116'],
                                                         at['CA:136']),
                               mean=17.0, stdev=5.0))

        rsr.add(forms.upper_bound(group=physical.xy_distance,
                               feature=features.distance(at['CA:223'],
                                                         at['CA:184']),
                               mean=17.0, stdev=5.0))
        ...
        rsr.add(forms.upper_bound(group=physical.xy_distance,
                               feature=features.distance(at['CA:48'],
                                                         at['CA:75']),
                               mean=17.0, stdev=5.0))
        ...
        rsr.add(forms.upper_bound(group=physical.xy_distance,
                               feature=features.distance(at['CA:132'],
                                                         at['CA:72']),
                               mean=17.0, stdev=5.0))

        rsr.add(forms.upper_bound(group=physical.xy_distance,
                               feature=features.distance(at['CA:198'],
                                                         at['CA:285']),
                               mean=17.0, stdev=5.0))

        rsr.add(forms.upper_bound(group=physical.xy_distance,
                               feature=features.distance(at['CA:339'],
                                                         at['CA:399']),
                               mean=17.0, stdev=5.0))

        rsr.add(forms.upper_bound(group=physical.xy_distance,
                               feature=features.distance(at['CA:425'],
                                                         at['CA:8']),
                               mean=17.0, stdev=5.0))
...
for files in os.listdir('.'):
    if fnmatch.fnmatch(files, 'ScNup133N.B*.pdb'):
        print files
        mdl = model(env, file=files)
        mdl.rename_segments('A', 56)
        mdl.write(files)
