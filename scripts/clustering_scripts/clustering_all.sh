...
ncoord=`cat $onepdb | grep ' CA ' | awk 'BEGIN {FIELDWIDTHS=" 6 5 1 4 1 3 1 1 4 1 3 8 8 8 6 6 6 4"};($8=="E"||$8=="G"||$8=="F"||$8=="B"){print}' | wc | awk '{print $1}'`

echo $onepdb $ncoord

# filter chains ($8=="E"||$8=="G"||$8=="F"||$8=="B")

((k=0)) ; for i in best_pdb/*.pdb ; do ((k++)) ; echo "XYZ" $k $i ; grep ' CA ' $i | awk 'BEGIN {FIELDWIDTHS=" 6 5 1 4 1 3 1 1 4 1 3 8 8 8 6 6 6 4"};($8=="E"||$8=="G"||$8=="F"||$8=="B"){print $12,$13,$14}' ; done > clustering/coor.xyz
